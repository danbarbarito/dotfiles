...
set -q color_fossil_dirty_bg; or set color_fossil_dirty_bg yellow
set -q color_fossil_dirty_str; or set color_fossil_dirty_str black
set -q color_fossil_bg; or set color_fossil_bg green
set -q color_fossil_str; or set color_fossil_str black
...
function prompt_fossil -d "Display the current fossil state"
    set -l separator "|"
    set -l info ""
    set -l merge_info ""
...
function fish_prompt
    ...
    if [ (cwd_in_scm_blacklist | wc -c) -eq 0 ]
        ...
        type -q fossil; and prompt_fossil
    end
    prompt_finish
end
