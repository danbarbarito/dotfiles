...
(defconst carbon-now-sh-baseurl "https://carbon.now.sh/?bg=rgba(171%2C 184%2C 195%2C 1)&t=seti&wt=none&l=auto&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=64px&ph=56px&ln=false&fm=Hack&fs=14px&lh=133%25&si=false&es=4x&wm=false")
